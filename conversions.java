...
public class conversions {
	...
	public static void main(String[] args) {
		...
		do {
			...
			double pounds, kilos, kms, miles, celsius, Fahrenheit;
			switch (option) {
			case 'A' :
			...
			case 'C' :
				...
				miles = kmsToM(kms);
				System.out.print(kms + " kilometers is " + miles + " miles");
				break;
			case 'D' :
				System.out.print("Enter the length in miles: ");
				miles = input.nextDouble();
				kms = milesTokms(miles);
				System.out.print(miles + " miles is " + kms + " kilometers");
				break;
			case 'E' :
	...
	public static double kmsToM(double kms) {
		return 0.621371*kms;
	}
